...
def Strategy_3(r,Payoff_Bank, payoff_matrix, budget, strat, percent_contribution_cat):
    ...
    if r>0 and r<=1:         
        ...
        if sec_max_laws != third_max_laws and sec_max_reserves != third_max_reserves and\
            ...
            if sec_max_laws==third_max_laws and sec_max_community==third_max_community:
                print("More than one battlefield has identical second and third sub-battlefield payoffs")
            if sec_max_reserves==third_max_reserves and sec_max_community==third_max_community:
                print("More than one battlefield has identical second and third sub-battlefield payoffs")
